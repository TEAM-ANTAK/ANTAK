...
--     SOURCE ANTAK     --
if text == "اهمس" or text == "همسه" or text == "اريد بوت الهمسه" or text == "دزلي بوت الهمسه" or  text == "دزولي بوت الهمسه" then  Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙@whisperbot', 1, 'md') end
...
Text = "• *The developer and programmer of this source is* : [- Not Developer](https://t.me/lTllTT)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='- 𝘢𝘣𝘣𝘢𝘴 𖤍 .',url="t.me/lTllTT"}}}
local msg_id = msg.id_/2097152/0.5
...
if text == 'abbas' or text == 'Dinero' then
