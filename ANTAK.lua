...
NameBot = (DevAbs:get(venom..'Abs:NameBot') or 'انتاك')
--     Source venom     --
...
if text and text:match('^'..(DevAbs:get(venom..'Abs:NameBot') or "انتاك")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(venom..'Abs:NameBot') or "انتاك")..' ','')
end
...
local BotName = (DevAbs:get(venom.."Abs:NameBot") or 'انتاك')
...
if text and text == (DevAbs:get(venom..'Abs:NameBot') or 'انتاك') then 
NameBot = (DevAbs:get(venom..'Abs:NameBot') or 'انتاك')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '᥀ venom Team .',url="t.me/F333F"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './venom.lua', '⌔︙نسخة ملف سورس انتاك',dl_cb, nil)
end end
--     Source venom     --
...
os.execute('wget https://raw.githubusercontent.com/TEAM-ANTAK/venom/master/venom.lua') 
dofile('venom.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAM-ANTAK/venomFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/TEAM-ANTAK/venomFiles/master/LaricAFiles/"..FileName)
if Res == 200 then
